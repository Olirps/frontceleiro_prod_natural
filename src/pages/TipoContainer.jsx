...
const TipoContainer = () => {
    ...
    const handleCadastrarModal = () => {
        checkPermission('tipocontainer', 'insert', () => {
            setIsModalOpen(true);
            setIsEdit(false);
    ...
    const handleEditClick = async (tipo) => {
        try {
            checkPermission('tipocontainer', 'viewcadastro', async () => {
    ...
    const handleAddTipo = async (e) => {
        try {
            checkPermission('tipocontainer', 'insert', async () => {
                const novoTipo = {
                    nome: e.nome,
    ...
    const handleEditSubmit = async (e) => {
        try {
            checkPermission('tipocontainer', 'edit', async () => {
                const updated = {
                    nome: e.nome,
                    descricao: e.descricao,
                    status: e.status
