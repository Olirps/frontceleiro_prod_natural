...
const ModalCadastraEmpresa = ({ isOpen, onClose, onSubmit, empresa, edit }) => {
                    ...
                    <div id='cadastro-padrao'>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => { setRazaoSocial(e.target.value) }} //forma resumida de atualizar o input
                                maxLength="150"
                                disabled={!permiteEditar}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="cnpj"
                                name="cnpj"
                                value={cpfCnpjMask(cnpj)} // Controlado pelo estado
                                onChange={(e) => { setCnpj(cpfCnpjMask(e.target.value)) }} //forma resumida de atualizar o input
                                disabled={!permiteEditar}
                                required
                            />
                        </div>
